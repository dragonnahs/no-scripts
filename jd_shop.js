/**
 ...
 [task_local]
 #进店领豆
 10 0 * * * https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_shop.js, tag=进店领豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_shop.png, enabled=true
 //Loon
 [Script]
 cron "10 0 * * *" script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_shop.js,tag=进店领豆
 //Surge
 进店领豆 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_shop.js
* */
const $ = new Env('进店领豆');
