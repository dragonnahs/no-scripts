 ...
 */
/**
 星推官脚本 https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_xtg.js
 ...
 [task_local]
 #京东星推官
 2 0 * * * https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_xtg.js, tag=京东星推官, enabled=true
 // Loon
 [Script]
 cron "2 0 * * *" script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_xtg.js,tag=京东星推官
 // Surge
 京东星推官 = type=cron,cronexp=2 0 * * *,wake-system=1,timeout=320,script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_xtg.js
 */
const $ = new Env('京东星推官');
...
async function showMsg() {
  ...
  if (nowTime > new Date(activeEndTime).getTime()) {
    $.msg($.name, '活动已结束', `请删除或禁用此脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/dragonnahs/no-scripts`, {"open-url": "https://github.com/dragonnahs/no-scripts"});
    if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `请删除此脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/dragonnahs/no-scripts`)
  } else {
