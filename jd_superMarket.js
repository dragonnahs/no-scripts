...
支持京东双账号
京小超兑换奖品请使用此脚本 https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_blueCoin.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
// QuantumultX
[task_local]
#京小超
11 1-23/5 * * * https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_superMarket.js, tag=京小超, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
// Loon
[Script]
cron "11 1-23/5 * * *" script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_superMarket.js,tag=京小超
// Surge
京小超 = type=cron,cronexp="11 1-23/5 * * *",wake-system=1,timeout=320,script-path=https://raw.githubusercontent.com/dragonnahs/no-scripts/master/jd_superMarket.js
 */
const $ = new Env('京小超');
